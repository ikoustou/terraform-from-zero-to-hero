...
subnet_private_tags       = {
  "Name"  = "Exercise-6-Private-Subnet"
}
subnet_private_cidr_block2 = "10.1.1.0/24"

#Public Route Table
route_table_public_tags    = {
  "Name"  = "Exercise-6-Public-Route-Table"
}

#Private Route Table
route_table_private_tags    = {
  "Name"  = "Exercise-6-Private-Route-Table"
}

#Internet Gateway
internet_gateway_tags    = {
  "Name"  = "Exercise-6-Internet_Gateway"
}
...
security_group_tags    = {
  "Name"  = "Exercise-6-Security-Groups-Ping-Public"
}
...
security_group_tags_ssh_public = {
  "Name"  = "Exercise-6-Security-Groups-SSH-Public"
}

#SG Ping Private
sg_cidr_blocks_private = [ "0.0.0.0/0" ]
security_group_tags_private = {
  "Name"  = "Exercise-6-Security-Groups-Ping-Private"
}
...
ec2_tags_public   = {
  "Name"  = "Exercise-6-EC2-Public"
}

#EC2 Private
ec2_tags_private = {
  "Name"  = "Exercise-6-EC2-Private"
}

#VPC peering
vpc_peering_tags = {
  "Name"  = "Exercise-6-Peering"
}

vpc_peering_accepter_tags = {
  "Name"  = "Exercise-6-Peering-Accepter"
}