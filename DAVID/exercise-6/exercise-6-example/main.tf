module "exercise_6_example" {
  ...
  subnet_private_name_2 = var.subnet_private_name_2

  subnet_public_cidr_block_2 = var.subnet_public_cidr_block_2
  subnet_public_name_2 = var.subnet_public_name_2

  rt_private_name_2 = var.rt_private_name_2

  rt_public_name_2 = var.rt_public_name_2
}